...
-   **Dry Run Mode:** Located on the main screen, this option allows you to run your entire bot sequence without it performing any actual actions (no clicks, typing, or scrolling). The bot will still search for targets and log what it *would* have done, providing a safe way to test your logic and ensure the sequence flows as expected.
